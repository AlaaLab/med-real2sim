# -*- coding: utf-8 -*-
'''
Estimates all the parameters of the model and the initial conditions: 
Tc, Rs, Rm, Ra, Rc, Ca, Cs, Cr, Ls, start_v, start_pla, start_pao (assuming start_pa=start_pao and start_Qt=0).
Only Emin=2.00 and Emax=0.06 are assumed. Vd has no effect on the equations so cannot be estimated.
'''
