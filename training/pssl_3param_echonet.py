...
# val_size = 50
learning_rate = 0.005
ID = '502_full_echonet_3param_Vloss'
...
output_path = '/accounts/biost/grad/keying_kuang/ML/interpolator3'
...
net = Interpolator()
net.load_state_dict(torch.load('/accounts/biost/grad/keying_kuang/ML/interpolator3/interp3_weight_2.pt'))
