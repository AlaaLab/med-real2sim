...
def f(Tc, start_v, startp, Rc, Emax, Emin, Vd):
    ...
    ved = sol[14 * 60000, 0] + Vd
    ves = sol[200*int(60/Tc)+9000+14*60000, 0] + Vd
    ef = (ved-ves)/ved * 100.
...
output_path = '/accounts/biost/grad/keying_kuang/ML/interpolator_7param'

np.save(os.path.join(output_path,'X_train.npy'), X_train)
np.save(os.path.join(output_path,'Y_train.npy'), Y_train)
np.save(os.path.join(output_path,'x_test_tc.npy'), x_test_tc)
np.save(os.path.join(output_path,'y_test_tc.npy'), y_test_tc)
...
torch.save(net.state_dict(), '/accounts/biost/grad/keying_kuang/ML/interpolator_7param/interp7param_weight_1.pt')
